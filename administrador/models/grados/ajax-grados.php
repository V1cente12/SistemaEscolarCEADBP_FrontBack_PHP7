...
if(!empty($_POST)) {
    if(empty($_POST['nombre'])) {
        ...
        if($result > 0) {
            $respuesta = array('status' => false,'msg' => 'La Especialidad ya existe');
        } else {
            if($idgrado == 0) {
            ...
            if($request > 0) {
                if($accion == 1) {
                    $respuesta = array('status' => true,'msg' => 'Especialidad creada correctamente');
                } else {
                    $respuesta = array('status' => true,'msg' => 'Especialidad actualizada correctamente');
                }
            }
        }
    }

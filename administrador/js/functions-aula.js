...
function openModalAula() {
    ...
    document.querySelector('#tituloModal').innerHTML = 'Nuevo Modulo';
...
function editarAula(id) {
    ...
    document.querySelector('#tituloModal').innerHTML = 'Actualizar Modulo';
...
function eliminarAula(id) {
    ...
    swal({
        ...
        text: "Realmente desea eliminar el Modulo?",
        type: "warning",
